          ...
          <Card className="border-none p-6">
            <div className={isMobile ? '' : 'flex items-center justify-between'}>
                ...
                >
                  <span
                    className={cn(
                      ...
                      data?.status === 'paid' ? 'bg-[#33D69F]' : data?.status === 'pending' ? 'bg-[#FF8F00]' : 'bg-[#373B53] dark:bg-[#dfe3fa]',
                    )}
                  />
              ...
              <div className="hidden items-center gap-3 md:flex">
                ...
                <Button className="rounded-3xl py-6 font-semibold" disabled={processingStatus || data?.status === 'paid'} onClick={updateStatus}>
