        ...
        <form className="space-y-12" onSubmit={submit}>
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
              <div className="flex flex-col gap-1">
                ...
                <Input type="text" placeholder="City" id="from_city" onChange={(e) => setData('from_city', e.target.value)} value={data.from_city} />
              </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <Input type="text" placeholder="Client's Name" onChange={(e) => setData('client_name', e.target.value)} value={data.client_name} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
              <div className="flex flex-col gap-1">
                ...
                <Input type="text" placeholder="City" onChange={(e) => setData('to_city', e.target.value)} value={data.to_city} id="to_city" />
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select value={String(data.payment_terms)} onValueChange={(value) => setData('payment_terms', parseInt(value))}>
                  <SelectTrigger className="w-full font-bold">
                    <SelectValue placeholder="Select a payment term">{getDisplayValue() || 'Select a payment term'}</SelectValue>{' '}
                  </SelectTrigger>
                  <SelectContent>
